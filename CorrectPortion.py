"""
This program check if the user took the correct amount of food by comparing the
ton of food each person gets and the amount of food the user got, each rounded
to 5 decimal places.
"""
